...
- **RF03 - Consulta de Jogos via IA Histórica (Múltiplas Gerações):** O sistema deve buscar dados dinamicamente de qualquer jogo da história (gerações PS1, PS2, PS3, PS4 e PS5) e exibir títulos oficiais e sinopses.
